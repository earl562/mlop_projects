...
@router.post("/deal-analysis/noi-valuation")
async def deal_analysis_noi_valuation(body: NoiValuationCalculationRequest) -> JsonObject:
    output = run_noi_valuation(body.input)
    return _persisted_or_output(body.run_id, body.input.model_dump(mode="json"), output)
