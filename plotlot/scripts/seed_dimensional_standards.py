...
ROWS: list[DistrictDimensionalStandard] = [
    ...
    DistrictDimensionalStandard(
        municipality="Fort Lauderdale", county="Broward", state="FL",
        district_code="RS-8", min_lot_area_sqft=6000, min_lot_width_ft=50,
        setback_front_ft=25, setback_side_ft=5, setback_rear_ft=15,
        max_height_ft=35, max_lot_coverage_pct=50, far=0.75,
    ...
    DistrictDimensionalStandard(
        municipality="Fort Lauderdale", county="Broward", state="FL",
        district_code="RS-4.4", min_lot_area_sqft=10000, min_lot_width_ft=75,
        setback_front_ft=25, setback_side_ft=10, setback_rear_ft=15,
        max_height_ft=35, max_lot_coverage_pct=45, far=0.75,
    ...
    DistrictDimensionalStandard(
        municipality="Fort Lauderdale", county="Broward", state="FL",
        district_code="RM-15", min_lot_area_sqft=5000, min_lot_width_ft=50,
        setback_front_ft=25, setback_side_ft=5, setback_rear_ft=15,
        max_height_ft=35, max_lot_coverage_pct=45, far=0.75,
    ...
    DistrictDimensionalStandard(
        ...
        district_code="R-1", min_lot_area_sqft=7500, min_lot_width_ft=75,
        setback_front_ft=25, setback_side_ft=7.5, setback_rear_ft=25,
        max_height_ft=35, max_lot_coverage_pct=40, far=0.50,
    ...
    DistrictDimensionalStandard(
        municipality="Miami", county="Miami-Dade", state="FL",
        district_code="R-3", min_lot_area_sqft=5000, min_lot_width_ft=50,
        setback_front_ft=15, setback_side_ft=5, setback_rear_ft=15,
        max_height_ft=45, max_lot_coverage_pct=50, far=0.80,
    ...
    DistrictDimensionalStandard(
        municipality="Miami", county="Miami-Dade", state="FL",
        district_code="R-4", min_lot_area_sqft=3750, min_lot_width_ft=40,
        setback_front_ft=15, setback_side_ft=5, setback_rear_ft=15,
        max_height_ft=60, max_lot_coverage_pct=55, far=1.20,
    ...
    DistrictDimensionalStandard(
        ...
        district_code="RS-5", min_lot_area_sqft=7500, min_lot_width_ft=60,
        setback_front_ft=25, setback_side_ft=7.5, setback_rear_ft=25,
        max_height_ft=35, max_lot_coverage_pct=40, far=0.50,
    ...
    DistrictDimensionalStandard(
        municipality="Hollywood", county="Broward", state="FL",
        district_code="RM-15", min_lot_area_sqft=3000, min_lot_width_ft=50,
        setback_front_ft=20, setback_side_ft=7.5, setback_rear_ft=20,
        max_height_ft=45, max_lot_coverage_pct=45, far=0.75,
        max_density_units_per_acre=15.0,
        source_section_id="STAGED: Hollywood ULDR Art. 9 (not yet ingested — assumption-grade)",
        source_url="https://www.hollywoodfl.gov/uldr",
    ),
    DistrictDimensionalStandard(
        municipality="Hollywood", county="Broward", state="FL",
        district_code="RM-25", min_lot_area_sqft=2000, min_lot_width_ft=40,
        setback_front_ft=15, setback_side_ft=5, setback_rear_ft=15,
        max_height_ft=65, max_lot_coverage_pct=55, far=1.50,
