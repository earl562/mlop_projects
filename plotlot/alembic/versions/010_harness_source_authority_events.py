...
revision = "010_harness_source_authority_events"
...
def upgrade() -> None:
    ...
    CREATE INDEX IF NOT EXISTS ix_jsa_authority_scope ON jurisdiction_source_authorities (authority_scope);
    CREATE INDEX IF NOT EXISTS ix_jsa_provider ON jurisdiction_source_authorities (provider);
    CREATE INDEX IF NOT EXISTS ix_jsa_municipality ON jurisdiction_source_authorities (municipality);
    ...
    CREATE INDEX IF NOT EXISTS ix_oss_content_hash ON ordinance_source_snapshots (content_hash);
    ...
    -- Extend ordinance_chunks with source-authority linkage (master spec §7).
    ...
    CREATE INDEX IF NOT EXISTS ix_oc_source_authority ON ordinance_chunks (source_authority_id);
    CREATE INDEX IF NOT EXISTS ix_oc_chunk_kind ON ordinance_chunks (chunk_kind);

    -- Extend ordinance_sections with source-authority linkage.
