...
def test_browser_comp_capture_normalizes_sparse_zillow_runner_candidates(tmp_path, monkeypatch) -> None:
    ...
    assert all(candidate["candidate_kind"] == "browser_listing_candidate" for candidate in candidates)
