...
async def persist_analysis_run_link(
    ...
    *,
    ...
    if existing_run is None:
        ...
        existing_run.workspace_id = context.workspace_id
        existing_run.project_id = context.project_id
        existing_run.site_id = context.site_id
        existing_run.analysis_id = context.analysis_id
        existing_run.skill_name = result.analysis_type
        existing_run.status = result.status
        existing_run.input_json = input_json
        existing_run.output_json = output_json
        existing_run.started_at = existing_run.started_at or now
