...
class LocalReportLedger:
    ...
    def list_claims(self, *, run_id: RunId | None = None) -> list[Claim]:
        ...
        filtered = claims if run_id is None else [claim for claim in claims if claim.run_id == run_id]
    ...
    def list_reports(self, *, run_id: RunId | None = None) -> list[Report]:
        ...
        filtered = reports if run_id is None else [report for report in reports if report.run_id == run_id]
