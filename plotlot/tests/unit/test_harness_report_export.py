...
def test_report_export_surfaces_acquisition_guidance_summary(tmp_path: Path) -> None:
    ...
    assert "public listing comps require county-record reconciliation before confident underwriting" in markdown
    ...
    assert "- Comping next action: reconcile public listing candidates to county records" in markdown
