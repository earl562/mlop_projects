...
_MIAMI_GARDENS_R1_TABLE_NODE_ID: Final[str] = (
    "SPBLADECO_CH34ZOLADE_ARTXIDESTGETADEST_S34-342TADEST"
)
...
def _parse_miami_gardens_r1_table(html: str) -> dict[str, float | str | bool] | None:
    ...
    numeric_fields = {
        ...
        "max_density_units_per_acre": _parse_density(general_rows.get("Density, maximum (net)", "")),
        "max_lot_coverage_pct": _parse_number(general_rows.get("Lot coverage principal building", "")),
