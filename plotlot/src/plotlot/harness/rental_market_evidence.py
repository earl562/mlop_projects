...
def resolve_rental_market_evidence(
    *,
    ...
    monthly_rent = _explicit_or_default(explicit_monthly_rent, cost_model.monthly_rent_per_unit_default)
    ...
    if not isinstance(explicit_operating_expense, int | float) and operating_expense_pct is not None:
