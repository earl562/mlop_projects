...
export default function AnalyzeConsolePage() {
  ...
  useEffect(() => {
    if (!isStreaming && messages.length === 0 && !latestMessageContent) return;
  ...
  return (
    <main className="coded-site analyze-shell">
      ...
      >
        ...
        <ul className="analyze-session-list" aria-label="Saved analysis sessions">
      ...
      <section className="analyze-workspace">
        ...
        <section className="analyze-main">
          <section className="analyze-console" aria-label="PlotLot agent console">
                    ...
                    {message.thinking && message.thinking.length > 0 && (
                      <div className="analyze-thinking">
                        {message.thinking.map((thinking) => (
                          <div key={`${message.id}-${thinking.step}-${thinking.thoughts.join("|")}`}>
            ...
            <fieldset className="analyze-suggestions">
          ...
          <aside className="analyze-rail" aria-label="Agent context">
            <section className="analyze-rail-card analyze-computer-card" data-testid="analyze-computer-card">
              ...
              <div className="analyze-computer-viewport" role="img" aria-label="Agent work preview">
